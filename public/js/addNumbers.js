 function addNumbers()
                {
                        ...
                        var fff = document.getElementById('val9').value;
                        var ggg = document.getElementById('val10').value;
                        var ans = parseFloat(unos)+parseFloat(aaa)+parseFloat(bbb)+parseFloat(ccc)+parseFloat(ddd)+parseFloat(eee)+parseFloat(fff)+parseFloat(ggg);
