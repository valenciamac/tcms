...
<div class="form-group" style="padding-bottom:45px;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                <input name="fname" required onkeypress="return checkNum();" onkeypress="limitText(this.form.limitedtextfield,this.form.countdown,20);" maxlength="20" placeholder="" required type="text" class="form-control" id="fname" value="{{ $polo->firstN}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                <input name="mname" required onkeypress="return checkNum();" onkeypress="limitText(this.form.limitedtextfield,this.form.countdown,20);" maxlength="20" placeholder="" required type="text" class="form-control" id="mname" value="{{ $polo->middleN }}">
                {{ $errors->first('fname', '<span class=errors>:message</span>') }}
            </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                <input name="lname" required onkeypress="return checkNum();" onkeypress="limitText(this.form.limitedtextfield,this.form.countdown,20);" maxlength="20" placeholder="" required type="text" class="form-control" id="lname" value="{{ $polo->lastN}}">
