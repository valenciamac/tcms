...
<div class="form-group" style="padding-bottom:45px;">
            ...
            <div class="form-group">
                <label for="lname" class="col-sm-2 control-label">Address:&nbsp;</label>
                <div class="col-sm-9">
                <input name="address" onkeypress="limitText(this.form.limitedtextfield,this.form.countdown,50);" maxlength="50" placeholder="" required type="text" class="form-control" id="address" value="{{ Input::old('lname') }}">
                {{ $errors->first('lname', '<span class=errors>:message</span>') }}
            </div>
            </div>
