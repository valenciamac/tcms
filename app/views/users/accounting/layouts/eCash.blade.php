<h2>Edit Cash Voucher</h2>
@if ($cashvouchers->count())
               
            @foreach ($cashvouchers as $cash)
...
<div class="form-group" style="padding-bottom:45px;">
      <div class="form-group">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                <input name="checkno" class="form-control" id="checkno" value="{{$cash->checkno}}">
                </div>
                </div>
                ...
                <div class="col-sm-6">
                <select name="rfrom" class="form-control" id="department" value="{{$cash->rfrom}}">
                ...
                <div class="col-sm-6">
                <input name="rpb" class="form-control" id="rpb" value="{{$cash->rpb}}">
                </div>
                </div>
