<div class="panel-group" id="accordion">
        ...
        <a class="btn btn-primary" href="cashvouchers" >
    Cash Vouchers
  </a>
  <a class="btn btn-primary" data-toggle="collapse" data-parent="#accordion" href="#rates">
    ...
    <div id="rates" class="panel-collapse collapse">
      ...
      <hr>
    {{Form::open(array('route' => 'checkvouchers.store','class'=>'form-horizontal','role'=>'form'))}}
...
<div>
     @include('users.accounting.layouts.viewcheck')
    </div>
    </div>
