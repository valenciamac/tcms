   ...
   <div class="container">
      ...
      <div class="masthead-pad">
         ...
         <div class="masthead-text">
            <h2>Employee</h2>
            <p>You have Office Employee registered in this system</p>
         </div> <!-- /.masthead-text -->
...
<div class="container mainB">
        ...
        <li class="">
            <a href="renew"><i class="fa fa-user link"></i>View Separation Employee</a>
        </li>
          <li>
         ...
         <li>
            <a href="purchases"><i class="fa fa-file link"></i>Report</a>
                ...
                <div class="col-lg-9">
                  @include('users.accounting.layouts.renew')
               </div>
