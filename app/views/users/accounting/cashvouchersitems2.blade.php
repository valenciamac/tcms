...
<div id="wrapper">
   ...
   <div class="container">
       @foreach($cashvouchers as $emp)
      <div class="masthead-pad">
         <div class="row">
         <div class="masthead-text">
            <h2>Vouchers</h2>
            <p>You made {{$cashitem->count()}} item for this cash voucher {{$emp->checkno}}</p>
         </div> <!-- /.masthead-text -->
      @endforeach <!-- /.masthead-text -->
...
<!-- 1st row -->
               <div class="row">
                <div class="col-lg-9">
                  @include('users.accounting.layouts.cashitems2')
               </div>
         </div>
</div>
         </div>
