   ...
   <div class="container">
      ...
      <div class="masthead-pad">
         ...
         <div class="masthead-text">
            <h2>Vouchers</h2>
            <p>You made {{$checkvouchers->count()}} check vouchers</p>
         </div> <!-- /.masthead-text -->
...
<!-- 1st row -->
               ...
               <div class="shortcut-area">
                     ...
                     <div class="stats-title underline">Total Cash Vouchers</div>
                     <div class="stats-number">{{$cashvouchers->count()}}</div>
                        </div>
                 </div>
               <div class="col-md-3 col-sm-6 ui-sortable">
                     <div class="widget widget-stats bg-red">
                     <div class="stats-icon stats-icon-lg"><i class="fa fa-money fa-fw"></i></div>
                     <div class="stats-title underline">Total Check Vouchers</div>
                ...
                <div class="col-md-3 col-sm-6 ui-sortable">
                     ...
                     <div class="stats-title underline">Total Requests for Payment</div>
                     <div class="stats-number">{{$rfp->count()}}</div> 
                        </div>
                 </div>
               ...
               <div class="row">
                <div class="col-lg-9">
                  @include('users.accounting.layouts.addcheck')
               </div>
