   ...
   <div class="container">
      ...
      <div class="masthead-pad">
         ...
         <div class="masthead-text">
            <h2>Financing Department</h2>
            <p>Your are now in the Financing Department</p>
         </div> <!-- /.masthead-text -->
...
<!-- PrefixFree -->
                ...
                <aside class="right">
                  ...
                  <ul class="intended sideMenu">
                      <li class="active">
                      <a href="financing"><i class="fa fa-home link"></i>Dashboard</a>
                  </li>
...
<!-- 1st row -->
               <div class="row">
                     ...
                     <div class="stats-title underline">Company Budget</div>
                     
                     <div class="stats-number">{{number_format($in->income,2)}}</div>
                        </div>
                 </div>
                 <div class="col-md-6 col-sm-6 ui-sortable">
                     <div class="widget widget-stats bg-blue">
                     <div class="stats-icon stats-icon-lg"><i class="fa fa-users fa-fw"></i></div>
                     <div class="stats-title underline">Total Project Budget</div>
                     <?php
                     $talto=0;
                     ?>
                     @foreach($budget as $bonj)
                     <?php
                    	$comein = $talto + $bonj->addincome;
                    	$talto = $comein;
                    	?>
                     @endforeach
                     <div class="stats-number">{{number_format($talto,2)}}</div>
                        </div>
                 </div>
               </div>
               </div>
