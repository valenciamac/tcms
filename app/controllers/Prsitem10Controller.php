...
class Prsitem10Controller extends \BaseController {
	...
	public function store()
	{
		$good = false;
		$input = Input::all();
		for($i = 0; $i < count(Input::get('plumid')); $i++) {
			$mason = Plumbing::find(Input::get('plumid')[$i]);
