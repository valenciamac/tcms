...
class Prsitem3Controller extends \BaseController {
	...
	public function store()
	{
		$good = false;
		$input = Input::all();
		for($i = 0; $i < count(Input::get('carpid')); $i++) {
			$mason = Carpentry::find(Input::get('carpid')[$i]);
