...
class Prsitem9Controller extends \BaseController {
	...
	public function store()
	{
		$good = false;
		$input = Input::all();
		for($i = 0; $i < count(Input::get('electid')); $i++) {
			$mason = Electrical::find(Input::get('electid')[$i]);
