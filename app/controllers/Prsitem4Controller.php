...
class Prsitem4Controller extends \BaseController {
	...
	public function store()
	{
		$good = false;
		$input = Input::all();
		for($i = 0; $i < count(Input::get('tinid')); $i++) {
			$mason = Thinmistry::find(Input::get('tinid')[$i]);
